-- From the bedroom checkpoint savestate: try to find the way out.
...
H.onFrame(function(f)
    ...
    if f % 40 == 0 and f <= 2200 then
        emu:screenshot(string.format("/tmp/rr_e1_%05d.png", f))
    end
    if f == 2200 then H.finish() end
end)
